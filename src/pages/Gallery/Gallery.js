  ...
  return (
    <div className={styles.gallery}>
      ...
      <div className={styles.gallery_items_container}>
        <div
          className={`${styles.gallery_item} ${itemSwitch.itemLeft == -1 && styles.item_left || itemSwitch.itemRight == -1 && styles.item_right || itemSwitch.itemActive === -1 && styles.item_active}`}
        ...
        <div
          className={`${styles.gallery_item} ${itemSwitch.itemLeft == 0 && styles.item_left || itemSwitch.itemRight == 0 && styles.item_right || itemSwitch.itemActive === 0 && styles.item_active}`}
